...
export default function Page() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-200/60 via-white to-pink-100 text-gray-900 font-sans px-6 pb-20">
      ...
      {/* FINAL MESSAGE */}
      <section className="max-w-3xl mx-auto mt-16 bg-white/80 backdrop-blur-md shadow-xl rounded-3xl p-8 border border-rose-100">
        <h3 className="text-center text-2xl font-bold text-rose-600 mb-4">
          Sobre nós dois
        </h3>
        ...
        <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
          ...
          <p>
            É doido pensar que tudo começou num beijo que “ia decidir tudo”, e
            hoje eu olho pra nossa vida e penso que não tinha como ser
            diferente. A gente se escolheu, e continua se escolhendo todo dia,
            no nosso jeito, no nosso ritmo, do nosso modo torto e perfeito.
          </p>

          <p>
            E é isso que eu quero: continuar vivendo a vida com você. Cuidando,
            rindo, insistindo, aprendendo, crescendo e amando. Porque,
            sinceramente… nada no mundo faz mais sentido do que construir a minha
            história com você.
          </p>
        </div>
